...
import { OrderNumberProvider } from "./context/production/OrderNoContext";
...
// import SalesOrderPage from "./components/operations/Sales/sales-process/SalesOrder";
// import DeliveryCopy from "./components/operations/Sales/delivery-notes/MainCopy";
// import DeliveryCopyPrintableContent from "./components/operations/Sales/delivery-notes/MainCopy";
// import PickSlipPrintableContent from "./components/operations/Sales/delivery-notes/PickSlip";
// import PickslipPage from "./components/operations/Pickslip";
import DeliveryNote from "./components/operations/Sales/outbound-logistics/deliveryPrint";
// import PickSlipPrint from "./components/operations/Pickslip";

import SalesModulePage from "./pages/Sales/SalesModulePage";
import SalesOrderPage from "./components/operations/Sales/sales-process/SalesOrder";
import { ProductProvider } from "./context/production/ProductContext";
import { PickslipProvider } from "./context/sales/PickSlipContext";
import { SalesModuleProvider } from "./context/sales/SalesModuleContext";
import PickSlipContent from "./components/operations/Sales/outbound-logistics/pickslipPrint/PickslipPage";
...
export default function App() {
  ...
  const [currentPrintTarget, setCurrentPrintTarget] =
    useState<PrintTarget>("none");
    ...
    <Router basename="/">
                ...
                <Routes>
                  ...
                  <Route element={<AppLayout />}>
                      ...
                      element={
                        <ProtectedRoute>
                          <ProductionOrderPage
                            ...
                            onPrint={handlePrintProductionReport}
                          />
                        </ProtectedRoute>
                      }
                    />
                    <Route
                      ...
                      element={
                        <ProtectedRoute>
                          <ProductionOrderReports />
                        </ProtectedRoute>
                      }
                    />
                    <Route
                      path="/production-orders/:productionHeaderID/details"
                      element={
                        <ProtectedRoute>
                    ...
                    />
                    <Route
                      path="/approved-production-order-details/:sapProductionOrderID"
                      element={
                        <ProtectedRoute>
                          <ApprovedProductionOrderDetailsPage />
                        </ProtectedRoute>
                      }
                    />
      ...
      <div
        ...
        className={`print-area ${
          currentPrintTarget === "productionReport"
            ? "is-active-print-target"
            : ""
        }`}
      >
        <PrintDisplay
      ...
      <div
        ...
        className={`print-area ${
          currentPrintTarget === "deliveryCopy" ? "is-active-print-target" : ""
        }`}
      >
        <DeliveryNote />
      </div>
      ...
      <div
        ...
        className={`print-area ${
          currentPrintTarget === "pickSlip" ? "is-active-print-target" : ""
        }`}
      >
