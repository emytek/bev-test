// src/ui/DatePicker.tsx (your DateTimeLocalInput component)
import React, { InputHTMLAttributes, CSSProperties } from 'react';

interface DateTimeLocalInputProps extends InputHTMLAttributes<HTMLInputElement> {
  label?: string;
  error?: string;
  className?: string;
  style?: CSSProperties;
...
const DateTimeLocalInput = React.forwardRef<HTMLInputElement, DateTimeLocalInputProps>(
...
DateTimeLocalInput.displayName = 'DateTimeLocalInput'; // Good practice
