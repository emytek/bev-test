...
import BarcodeGenerator from "../Sales/delivery-notes/MainCopy/DocumentDetail/BarcodeGenerator"; // Assuming this path is correct for your project
import SmallTablePickslip from "../Sales/delivery-notes/PickSlip/Header/Table"; // Assuming this path is correct

const PlaceholderLogo = () => (
  <div className="flex items-center justify-center h-full text-lg font-bold text-gray-700 print:text-[7pt]">
    LOGO
  </div>
);
    ...
    <div className="p-1 sm:p-2 bg-white shadow-sm mt-0 print:p-0.5 print:mt-0"> {/* Reduced overall padding and top margin */}
      ...
      <div className="grid grid-cols-6 grid-rows-4 gap-x-1 gap-y-0.5 print:gap-x-[2px] print:gap-y-[0px]">
        ...
        <div className="col-span-2 flex items-center justify-center border-2 border-black p-0.5 rounded-sm flex-col h-[40px] print:h-[15mm] print:p-[1px]">
          <p className="font-bold text-md md:text-lg print:text-[10pt]"> {/* Reduced print font size */}
            PICKSLIP
          </p>
        </div>
        {/* SECOND MAIN ROW */}
        ...
        <div className="col-span-1 pt-px print:pt-[1px]"> {/* Reduced print pt */}
          <p className="font-bold leading-tight print:text-[7pt]">Deliver From</p>
        </div>
        <div className="col-span-1 pt-px print:pt-[1px] print:text-[8pt]"> {/* Reduced print pt */}
          <address className="not-italic leading-tight print:text-[7pt] print:leading-tight">
        ...
        <div className="col-span-2 flex flex-col items-center justify-start p-0 pt-0.5 print:pt-[2px] print:h-[15mm]"> {/* Reduced print padding and height */}
          ...
          <span className="mt-0 text-sm print:text-[7pt] print:mt-[1px]">07412363</span> {/* Reduced print text size and margin */}
        </div>
      </div>
    </div>
  );
