...
//   return (
//     <header className="p-4 border border-gray-300 mx-auto w-[210mm] min-h-[297mm] font-sans text-xs print:w-auto print:min-h-0 print:p-2 print:border-0">
//       {/* Header Grid */}
//       <div className="grid grid-cols-6 gap-x-2 h-auto">
//         {/* Row 1 */}
...
//         <div className="col-span-1"></div> {/* Empty */}
//         <div className="col-span-1 text-right leading-tight">
...
//           <p>Nigeria</p>
//         </div>
//         <div className="col-span-2 flex items-center justify-center p-2 border-2 border-gray-700 rounded-lg shadow-sm text-center h-[50px]">
...
//           <h3 className="text-sm font-semibold mb-1">Customer Copy</h3>
//           <div className="grid grid-cols-3 text-xxs border border-black">
//             {" "}
//             {/* Removed gap-1 */}
//             <div className="col-span-1 p-1 border-r border-b border-black font-medium">
//               Delivery Note
//             </div>
//             <div className="col-span-1 p-1 border-r border-b border-black">
//               50204741
//             </div>
...
//             <div className="col-span-1 p-1 border-r border-black font-medium">
//               Shipment Number/ Load Number
//             </div>
...
//         </div>
//         {/* Row 3 */}
//         <div className="col-span-1 text-left font-semibold">Deliver From</div>
//         <div className="col-span-1 leading-tight">
//           <p>Alucan Packaging Limited</p>
//           <p>Km32 Area 5 Opic Industrial Estate</p>
//           <p>Agbara</p>
...
//           <p>Nigeria</p>
//         </div>
//         <div className="col-span-1 text-left font-semibold">Deliver To</div>
//         <div className="col-span-1 leading-tight">
...
//           <p>Nigeria</p>
//         </div>
//         <div className="col-span-1 text-left font-semibold">For Account</div>
//         <div className="col-span-1 leading-tight">
//           <p>NigerianBreweries PLC</p>
...
const DeliveryNoteHeader: React.FC<DeliveryNoteHeaderProps> = ({ logoSrc }) => {
  return (
    // Removed fixed width and height. Use w-full to adapt to parent's landscape width.
    // Adjust print padding to be smaller for better fit.
    <header className="p-2 border border-gray-300 w-full font-sans text-xs print:p-1 print:border-0">
      {/* Header Grid */}
      {/* Ensure gap-x is appropriate for landscape, maybe smaller for print */}
      <div className="grid grid-cols-6 gap-x-1 h-auto print:gap-x-0.5">
        ...
        <div className="col-span-2 flex flex-col items-center justify-center">
          ...
          {/* Ensure this grid's columns are flexible for print */}
        ...
        <div className="col-span-1 text-left font-semibold print:text-[8pt]">Deliver From</div>
        <div className="col-span-1 leading-tight print:text-[8pt]">
          <p>Alucan Packaging Limited</p>
          <p>Km32 Area 5 Opic Industrial Estate</p>
          <p>Agbara</p>
